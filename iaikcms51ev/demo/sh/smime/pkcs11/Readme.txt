...
(and path to) the PKCS#11 module to be used:
   ...
   ./runImplicitSignedMailDemo.sh <PKCS#11 module name> 

e.g. (assuming that the module to be used ("aetpkss1.so" for 
      G&D StarCos and Rainbow iKey 3000) is located in your
      current working directory):

   ./runImplicitSignedMailDemo.sh aetpkss1.so 
...
(and path to) the PKCS#11 module to be used:
   ...
   ./runEncryptedMailDemo.sh <PKCS#11 module name> 

e.g. (assuming that the module to be used ("aetpkss1.so" for 
      G&D StarCos and Rainbow iKey 3000) is located in your
      current working directory):

   ./runEncryptedMailDemo.sh aetpkss1.so  
