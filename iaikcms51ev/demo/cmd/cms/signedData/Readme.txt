...
Start the demo by running the batch file and specifying the
.p7c file to be parsed:

   > runCertListDemo.bat <cert list file>

e.g.:

  > runCertListDemo.bat certList.p7c
...
Start the demo by running
   ...
   > runSignedDataOutputStreamDemo.bat 
...
Start the demo by running
   ...
   > runSignedDataDemoWithAdditionalSignerInfo.bat 
...
Start the demo by running
   ...
   > runSignedDataStreamDemoWithAdditionalSignerInfo.bat 
