This directory contains a cmd file for running basic
CMS demos showing the usage of all content type 
implementations (AuthenticatedData, CompressedData,
Data, DigestedData, EncryptedData, EnvelopedData,
SignedData).
