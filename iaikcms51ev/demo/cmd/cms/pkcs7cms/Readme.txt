This directory contains cmd files for running PKCS#7 - CMS
...
Start the demo by running
   ...
   > runPKCS7CMSDigestedDataDemo.bat 
...
Start the demo by running
   ...
   > runPKCS7CMSEncryptedContentInfoDemo.bat 
...
Start the demo by running
   ...
   > runPKCS7CMSEncryptedDataDemo.bat 
...
Start the demo by running
   ...
   > runPKCS7CMSEnvelopedDataDemo.bat 
